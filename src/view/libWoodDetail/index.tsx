...
import { Container, PaperText, PaperImage, TextContainer, PaperSource, CommonName } from './styles'

const LibFishDetail: React.FC<NavPropsLibWoodDetail> = ({ route }) => {
  const { data: selectedWood, isFetching } = useQuery(`getWood${route.params.woodId}`, () =>
  ...
  return (
    <Container showsVerticalScrollIndicator={false}>
      ...
      <TextContainer>
        ...
        {!!selectedWood.description && <PaperText>{selectedWood.description}</PaperText>}
